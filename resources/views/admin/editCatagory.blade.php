    ...
    @section('admin')
        ...
        <div>
            <form method="POST" action="{{ route('updateCatagory') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <img id="showimage" class="img-profile rounded avatar-lg"
                        src=" {{ !empty($cat->catagory_image) ? Url('upload/user_images/' . $cat->catagory_image) : Url('upload/user_images/noImage.png') }} "
